...
function Navbar({currentLink, setCurrentLink, setLoading}) {
  ...
  return (
    <div className="qHeader">
      ...
      <div className="qHeader__icons">
        <div onClick={() => {setCurrentLink("HomeIcon");setLoading(false)}} className={`qHeader__icon ${currentLink === "HomeIcon" && "selected"}`}>
          <HomeIcon />
        </div>
